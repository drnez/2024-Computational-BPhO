...
export default function NineVx({navigation, route}) {
    ...
    const normal_xy = {
        ...
        y: route.params.normal_all.vx,
    };
    const ar_xy = {
        x: route.params.ar_all.t,
        y: route.params.ar_all.vx,
    };
        ...
        <Default
            ...
            sliders={
                <>
                    ...
                    <Button
                        title="Next"
                        onPress={() => navigation.navigate("Challenge Nine (4)", {normal_all, ar_all} )}
                    />
                    <Button
                        title="Back"
